...
class MNISTMLP_OC(nn.Module):
    ...
    def __init__(self, input_size: int, embedding_dim: int, output_size: int) -> None:
        """
        ...
        self.fc1 = nn.Linear(self.input_size, 128, bias=False)
        self.fc2 = nn.Linear(128, 256, bias=False)
        self.fc3 = nn.Linear(256, self.embedding_dim, bias=False)
